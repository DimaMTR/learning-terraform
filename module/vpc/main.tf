...
resource "google_compute_firewall" "http-rule-in"{ 
  name          = "${var.environment.name}-http-rule-in"
...
resource "google_compute_firewall" "http-rule-out"{ 
  name        = "${var.environment.name}-http-rule-out"
